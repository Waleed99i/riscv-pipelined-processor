...
VL_ATTR_COLD void Vtb_without_hazards___024root___eval_initial__TOP(Vtb_without_hazards___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_without_hazards___024root___eval_initial__TOP\n"); );
    Vtb_without_hazards__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
#endif
            VL_FATAL_MT("tests/tb_without_hazards.sv", 78, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
...
VL_ATTR_COLD void Vtb_without_hazards___024root___ctor_var_reset(Vtb_without_hazards___024root* vlSelf) {
    ...
    vlSelf->tb_without_hazards__DOT__dut__DOT__wd_rf_3 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 15588889552053311643ull);
    ...
    vlSelf->tb_without_hazards__DOT__dut__DOT__alu_ctrl_inst__DOT__alu_operation = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 1429002794185359792ull);
