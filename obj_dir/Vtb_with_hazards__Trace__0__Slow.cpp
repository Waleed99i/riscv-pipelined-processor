...
#include "Vtb_with_hazards__Syms.h"


VL_ATTR_COLD void Vtb_with_hazards___024root__trace_init_sub__TOP__0(Vtb_with_hazards___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_with_hazards___024root__trace_init_sub__TOP__0\n"); );
    Vtb_with_hazards__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    const int c = vlSymsp->__Vm_baseCode;
    VL_TRACE_PUSH_PREFIX(tracep, "tb_with_hazards", VerilatedTracePrefixType::SCOPE_MODULE, 0, 0);
...
VL_ATTR_COLD void Vtb_with_hazards___024root__trace_init_dtype_sub____0(Vtb_with_hazards___024root* vlSelf, VerilatedVcd* tracep, const char* name, uint32_t fidx, uint32_t c, VerilatedTraceSigDirection direction);

VL_ATTR_COLD void Vtb_with_hazards___024root__trace_init_dtype____0(Vtb_with_hazards___024root* vlSelf, VerilatedVcd* tracep, const char* name, uint32_t fidx, uint32_t c, VerilatedTraceSigDirection direction) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_with_hazards___024root__trace_init_dtype____0\n"); );
    Vtb_with_hazards__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vtb_with_hazards___024root__trace_init_dtype_sub____0(vlSelf, tracep, name, fidx, c, direction);
}

VL_ATTR_COLD void Vtb_with_hazards___024root__trace_init_dtype_sub____0(Vtb_with_hazards___024root* vlSelf, VerilatedVcd* tracep, const char* name, uint32_t fidx, uint32_t c, VerilatedTraceSigDirection direction) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_with_hazards___024root__trace_init_dtype_sub____0\n"); );
    Vtb_with_hazards__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtb_with_hazards___024root__trace_init_top(Vtb_with_hazards___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_with_hazards___024root__trace_init_top\n"); );
    Vtb_with_hazards__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vtb_with_hazards___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vtb_with_hazards___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void Vtb_with_hazards___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vtb_with_hazards___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vtb_with_hazards___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/);

VL_ATTR_COLD void Vtb_with_hazards___024root__trace_register(Vtb_with_hazards___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_with_hazards___024root__trace_register\n"); );
    Vtb_with_hazards__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vtb_with_hazards___024root__trace_const_0, 0, vlSelf);
    tracep->addFullCb(&Vtb_with_hazards___024root__trace_full_0, 0, vlSelf);
    tracep->addChgCb(&Vtb_with_hazards___024root__trace_chg_0, 0, vlSelf);
    tracep->addCleanupCb(&Vtb_with_hazards___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vtb_with_hazards___024root__trace_const_0_sub_0(Vtb_with_hazards___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vtb_with_hazards___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_with_hazards___024root__trace_const_0\n"); );
    // Body
    Vtb_with_hazards___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vtb_with_hazards___024root*>(voidSelf);
    Vtb_with_hazards__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    Vtb_with_hazards___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vtb_with_hazards___024root__trace_const_0_sub_0(Vtb_with_hazards___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_with_hazards___024root__trace_const_0_sub_0\n"); );
    Vtb_with_hazards__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtb_with_hazards___024root__trace_full_0_sub_0(Vtb_with_hazards___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vtb_with_hazards___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_with_hazards___024root__trace_full_0\n"); );
    // Body
    Vtb_with_hazards___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vtb_with_hazards___024root*>(voidSelf);
    Vtb_with_hazards__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    Vtb_with_hazards___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vtb_with_hazards___024root__trace_full_0_sub_0(Vtb_with_hazards___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_with_hazards___024root__trace_full_0_sub_0\n"); );
    Vtb_with_hazards__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    bufp->fullIData(oldp+0,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__dmem_inst__DOT__memory[128U]),32);
    bufp->fullIData(oldp+1,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__dmem_inst__DOT__memory[129U]),32);
    bufp->fullIData(oldp+2,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__dmem_inst__DOT__memory[130U]),32);
    bufp->fullIData(oldp+3,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__dmem_inst__DOT__memory[131U]),32);
    bufp->fullIData(oldp+4,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__imem_inst__DOT__memory
                            [(0x000000ffU & (vlSelfRef.tb_with_hazards__DOT__dut__DOT__pc 
                                             >> 2U))]),32);
    bufp->fullCData(oldp+5,((0x0000001fU & (vlSelfRef.tb_with_hazards__DOT__dut__DOT__imem_inst__DOT__memory
                                            [(0x000000ffU 
                                              & (vlSelfRef.tb_with_hazards__DOT__dut__DOT__pc 
                                                 >> 2U))] 
                                            >> 7U))),5);
    bufp->fullCData(oldp+6,((vlSelfRef.tb_with_hazards__DOT__dut__DOT__imem_inst__DOT__memory
                             [(0x000000ffU & (vlSelfRef.tb_with_hazards__DOT__dut__DOT__pc 
                                              >> 2U))] 
                             >> 0x00000019U)),7);
    bufp->fullIData(oldp+7,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[31]),32);
    bufp->fullIData(oldp+8,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[30]),32);
    bufp->fullIData(oldp+9,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[29]),32);
    bufp->fullIData(oldp+10,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[28]),32);
    bufp->fullIData(oldp+11,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[27]),32);
    bufp->fullIData(oldp+12,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[26]),32);
    bufp->fullIData(oldp+13,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[25]),32);
    bufp->fullIData(oldp+14,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[24]),32);
    bufp->fullIData(oldp+15,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[23]),32);
    bufp->fullIData(oldp+16,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[22]),32);
    bufp->fullIData(oldp+17,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[21]),32);
    bufp->fullIData(oldp+18,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[20]),32);
    bufp->fullIData(oldp+19,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[19]),32);
    bufp->fullIData(oldp+20,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[18]),32);
    bufp->fullIData(oldp+21,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[17]),32);
    bufp->fullIData(oldp+22,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[16]),32);
    bufp->fullIData(oldp+23,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[15]),32);
    bufp->fullIData(oldp+24,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[14]),32);
    bufp->fullIData(oldp+25,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[13]),32);
    bufp->fullIData(oldp+26,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[12]),32);
    bufp->fullIData(oldp+27,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[11]),32);
    bufp->fullIData(oldp+28,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[10]),32);
    bufp->fullIData(oldp+29,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[9]),32);
    bufp->fullIData(oldp+30,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[8]),32);
    bufp->fullIData(oldp+31,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[7]),32);
    bufp->fullIData(oldp+32,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[6]),32);
    bufp->fullIData(oldp+33,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[5]),32);
    bufp->fullIData(oldp+34,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[4]),32);
    bufp->fullIData(oldp+35,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[3]),32);
    bufp->fullIData(oldp+36,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[2]),32);
    bufp->fullIData(oldp+37,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[1]),32);
    bufp->fullIData(oldp+38,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf[0]),32);
    bufp->fullBit(oldp+39,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__stall));
    bufp->fullIData(oldp+40,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__imm_1),32);
    bufp->fullBit(oldp+41,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__we_rf_1));
    bufp->fullCData(oldp+42,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__alu_op_1),2);
    bufp->fullBit(oldp+43,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__mem_to_reg_1));
    bufp->fullCData(oldp+44,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rmask_1),2);
    bufp->fullCData(oldp+45,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__wmask_1),2);
    bufp->fullBit(oldp+46,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__mem_wen_1));
    bufp->fullBit(oldp+47,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__load_unsigned_1));
    bufp->fullBit(oldp+48,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__branch_1));
    bufp->fullBit(oldp+49,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__jump_1));
    bufp->fullBit(oldp+50,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__jump_reg_1));
    ...
    bufp->fullIData(oldp+55,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__mem_rdata_2),32);
    bufp->fullIData(oldp+56,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__pc_next),32);
    bufp->fullIData(oldp+57,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__pc),32);
    bufp->fullBit(oldp+58,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__flush));
    bufp->fullIData(oldp+59,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__inst_2),32);
    bufp->fullIData(oldp+60,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__pc_2),32);
    bufp->fullIData(oldp+61,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__imm_2),32);
    bufp->fullIData(oldp+62,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rd1_2),32);
    bufp->fullIData(oldp+63,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rd2_2),32);
    bufp->fullBit(oldp+64,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__we_rf_2));
    bufp->fullCData(oldp+65,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__alu_op_2),2);
    bufp->fullBit(oldp+66,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__mem_to_reg_2));
    bufp->fullCData(oldp+67,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__rmask_2),2);
    bufp->fullCData(oldp+68,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__wmask_2),2);
    bufp->fullBit(oldp+69,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__mem_wen_2));
    bufp->fullBit(oldp+70,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__load_unsigned_2));
    bufp->fullBit(oldp+71,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__branch_2));
    bufp->fullBit(oldp+72,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__jump_2));
    bufp->fullBit(oldp+73,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__jump_reg_2));
    bufp->fullCData(oldp+74,((0x0000001fU & (vlSelfRef.tb_with_hazards__DOT__dut__DOT__inst_2 
                                             >> 0x0000000fU))),5);
    bufp->fullCData(oldp+75,((0x0000001fU & (vlSelfRef.tb_with_hazards__DOT__dut__DOT__inst_2 
                                             >> 0x00000014U))),5);
    bufp->fullCData(oldp+76,((0x0000001fU & (vlSelfRef.tb_with_hazards__DOT__dut__DOT__inst_2 
                                             >> 7U))),5);
    bufp->fullCData(oldp+77,((0x0000007fU & vlSelfRef.tb_with_hazards__DOT__dut__DOT__inst_2)),7);
    bufp->fullCData(oldp+78,((7U & (vlSelfRef.tb_with_hazards__DOT__dut__DOT__inst_2 
                                    >> 0x0000000cU))),3);
    bufp->fullCData(oldp+79,((vlSelfRef.tb_with_hazards__DOT__dut__DOT__inst_2 
                              >> 0x00000019U)),7);
    bufp->fullCData(oldp+80,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__alu_ctrl_inst__DOT__alu_operation),4);
    bufp->fullIData(oldp+81,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__alu_inst__DOT__result),32);
    bufp->fullBit(oldp+82,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__branch_taken_2));
    bufp->fullIData(oldp+83,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__forwarded_rs1_2),32);
    bufp->fullIData(oldp+84,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__forwarded_rs2_2),32);
    bufp->fullIData(oldp+85,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__alu_inst__DOT__op_A),32);
    bufp->fullIData(oldp+86,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__alu_srcB_2),32);
    bufp->fullBit(oldp+87,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__we_rf_3));
    bufp->fullCData(oldp+88,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__waddr_rf_3),5);
    bufp->fullIData(oldp+89,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__wd_rf_3),32);
    bufp->fullBit(oldp+90,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__mem_to_reg_3));
    bufp->fullIData(oldp+91,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__alu_out_3),32);
    bufp->fullIData(oldp+92,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__mem_rdata_3),32);
    bufp->fullBit(oldp+93,((0U == vlSelfRef.tb_with_hazards__DOT__dut__DOT__alu_inst__DOT__result)));
    bufp->fullBit(oldp+94,((vlSelfRef.tb_with_hazards__DOT__dut__DOT__forwarded_rs1_2 
                            == vlSelfRef.tb_with_hazards__DOT__dut__DOT__forwarded_rs2_2)));
    bufp->fullBit(oldp+95,(VL_LTS_III(32, vlSelfRef.tb_with_hazards__DOT__dut__DOT__forwarded_rs1_2, vlSelfRef.tb_with_hazards__DOT__dut__DOT__forwarded_rs2_2)));
    bufp->fullBit(oldp+96,((vlSelfRef.tb_with_hazards__DOT__dut__DOT__forwarded_rs1_2 
                            < vlSelfRef.tb_with_hazards__DOT__dut__DOT__forwarded_rs2_2)));
    bufp->fullCData(oldp+97,((0x000000ffU & (vlSelfRef.tb_with_hazards__DOT__dut__DOT__alu_inst__DOT__result 
                                             >> 2U))),8);
    bufp->fullBit(oldp+98,(vlSelfRef.tb_with_hazards__DOT__clk));
    bufp->fullBit(oldp+99,(vlSelfRef.tb_with_hazards__DOT__rst));
    bufp->fullIData(oldp+100,((vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf
                               [vlSelfRef.__VdfgRegularize_h6e95ff9d_0_2] 
                               & (- (IData)((0U != (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_2)))))),32);
    bufp->fullIData(oldp+101,((vlSelfRef.tb_with_hazards__DOT__dut__DOT__rf_inst__DOT__rf
                               [vlSelfRef.__VdfgRegularize_h6e95ff9d_0_3] 
                               & (- (IData)((0U != (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_3)))))),32);
    bufp->fullIData(oldp+102,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__dmem_inst__DOT__unnamedblk1__DOT__current_word),32);
    bufp->fullSData(oldp+103,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__dmem_inst__DOT__unnamedblk1__DOT__half_word),16);
    bufp->fullCData(oldp+104,(vlSelfRef.tb_with_hazards__DOT__dut__DOT__dmem_inst__DOT__unnamedblk1__DOT__byte_val),8);
}
