...
VlCoroutine Vtb_insertion_sort___024root___eval_initial__TOP__Vtiming__1(Vtb_insertion_sort___024root* vlSelf) {
    ...
    IData/*31:0*/ tb_insertion_sort__DOT__unnamedblk1_3__DOT____Vrepeat2;
    tb_insertion_sort__DOT__unnamedblk1_3__DOT____Vrepeat2 = 0;
    // Body
    ...
    tb_insertion_sort__DOT__unnamedblk1_2__DOT____Vrepeat1 = 0x000186a0U;
    ...
    tb_insertion_sort__DOT__unnamedblk1_3__DOT____Vrepeat2 = 2U;
    while (VL_LTS_III(32, 0U, tb_insertion_sort__DOT__unnamedblk1_3__DOT____Vrepeat2)) {
        Vtb_insertion_sort___024root____VbeforeTrig_hbab1bcef__0(vlSelf, 
                                                                 "@(posedge tb_insertion_sort.clk)");
        co_await vlSelfRef.__VtrigSched_hbab1bcef__0.trigger(0U, 
                                                             nullptr, 
                                                             ...
                                                             "tests/tb_insertion_sort.sv", 
                                                             47);
        tb_insertion_sort__DOT__unnamedblk1_3__DOT____Vrepeat2 
            = (tb_insertion_sort__DOT__unnamedblk1_3__DOT____Vrepeat2 
               - (IData)(1U));
    }
    VL_WRITEF_NX("Execution finished.\n",0);
    if (VL_UNLIKELY(((1U != vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory[128U])))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_insertion_sort.sv:52: Assertion failed in %m: arr[0] failed: %0d\n",4, 'M',vlSymsp->name(),"tb_insertion_sort", 'T',-12
                     , '#',64,VL_TIME_UNITED_Q(1), '#',32,vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory[128U]);
        VL_STOP_MT("tests/tb_insertion_sort.sv", 52, "", false);
    }
    if (VL_UNLIKELY(((2U != vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory[129U])))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_insertion_sort.sv:53: Assertion failed in %m: arr[1] failed: %0d\n",4, 'M',vlSymsp->name(),"tb_insertion_sort", 'T',-12
                     , '#',64,VL_TIME_UNITED_Q(1), '#',32,vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory[129U]);
        VL_STOP_MT("tests/tb_insertion_sort.sv", 53, "", false);
    }
    if (VL_UNLIKELY(((3U != vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory[130U])))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_insertion_sort.sv:54: Assertion failed in %m: arr[2] failed: %0d\n",4, 'M',vlSymsp->name(),"tb_insertion_sort", 'T',-12
                     , '#',64,VL_TIME_UNITED_Q(1), '#',32,vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory[130U]);
        VL_STOP_MT("tests/tb_insertion_sort.sv", 54, "", false);
    }
    if (VL_UNLIKELY(((4U != vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory[131U])))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_insertion_sort.sv:55: Assertion failed in %m: arr[3] failed: %0d\n",4, 'M',vlSymsp->name(),"tb_insertion_sort", 'T',-12
                     , '#',64,VL_TIME_UNITED_Q(1), '#',32,vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory[131U]);
        VL_STOP_MT("tests/tb_insertion_sort.sv", 55, "", false);
    }
    VL_WRITEF_NX("\033[0;32mtb_insertion_sort PASS\033[0m\n",0);
    VL_FINISH_MT("tests/tb_insertion_sort.sv", 58, "");
    co_return;
}
...
void Vtb_insertion_sort___024root___act_sequent__TOP__0(Vtb_insertion_sort___024root* vlSelf) {
    ...
    vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__unnamedblk1__DOT__current_word 
        = vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory
        [(0x000000ffU & (vlSelfRef.tb_insertion_sort__DOT__dut__DOT__alu_inst__DOT__result 
                         >> 2U))];
        ...
        __Vtemp_1 = ((0U == (IData)(vlSelfRef.tb_insertion_sort__DOT__dut__DOT__wmask_2))
                      ...
                      : ((1U == (IData)(vlSelfRef.tb_insertion_sort__DOT__dut__DOT__wmask_2))
                          ...
                          : ((2U == (IData)(vlSelfRef.tb_insertion_sort__DOT__dut__DOT__wmask_2))
                             ...
                             [(0x000000ffU & (vlSelfRef.tb_insertion_sort__DOT__dut__DOT__alu_inst__DOT__result 
                                              >> 2U))])));
        vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory[(0x000000ffU 
                                                                            & (vlSelfRef.tb_insertion_sort__DOT__dut__DOT__alu_inst__DOT__result 
                                                                               >> 2U))] 
            = __Vtemp_1;
    }
