...
VL_ATTR_COLD void Vtb_cpu___024root___ctor_var_reset(Vtb_cpu___024root* vlSelf) {
    ...
    vlSelf->tb_cpu__DOT__dut__DOT__rf_inst__DOT__wd_rf = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 685997990797428178ull);
    ...
    vlSelf->tb_cpu__DOT__dut__DOT__alu_inst__DOT__alu_operation = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 14738283075040648867ull);
