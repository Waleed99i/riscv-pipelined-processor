...
VL_ATTR_COLD void Vtb_cpu___024root___eval_static(Vtb_cpu___024root* vlSelf) {
    ...
    // Locals
    IData/*31:0*/ __Vinline__eval_static__TOP_tb_cpu__DOT__dut__DOT__dmem_inst__DOT__unnamedblk1__DOT__current_word;
    __Vinline__eval_static__TOP_tb_cpu__DOT__dut__DOT__dmem_inst__DOT__unnamedblk1__DOT__current_word = 0;
    // Body
...
VL_ATTR_COLD void Vtb_cpu___024root___ctor_var_reset(Vtb_cpu___024root* vlSelf) {
    ...
    vlSelf->tb_cpu__DOT__dut__DOT__alu_out_2 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 11670480907309508090ull);
