...
class alignas(VL_CACHE_LINE_BYTES) Vtb_imem___024root final {
  public:
    ...
    IData/*31:0*/ __Vi;
    VlUnpacked<IData/*31:0*/, 1048576> tb_imem__DOT__dut__DOT__memory;
    ...
    // INTERNAL VARIABLES
    Vtb_imem__Syms* vlSymsp;
    const char* vlNamep;

    // CONSTRUCTORS
    Vtb_imem___024root(Vtb_imem__Syms* symsp, const char* namep);
    ~Vtb_imem___024root();
