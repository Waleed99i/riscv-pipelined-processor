...
VL_ATTR_COLD void Vtb_insertion_sort___024root__trace_full_0_sub_0(Vtb_insertion_sort___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+4,(vlSelfRef.tb_insertion_sort__DOT__dut__DOT__imem_inst__DOT__memory
                            [(0x0000007fU & (vlSelfRef.tb_insertion_sort__DOT__dut__DOT__pc 
                                             >> 2U))]),32);
    ...
    bufp->fullCData(oldp+79,((vlSelfRef.tb_insertion_sort__DOT__dut__DOT__inst_2 
                              >> 0x00000019U)),7);
    bufp->fullCData(oldp+80,(vlSelfRef.tb_insertion_sort__DOT__dut__DOT__alu_inst__DOT__alu_operation),4);
    ...
    bufp->fullIData(oldp+89,(vlSelfRef.tb_insertion_sort__DOT__dut__DOT__rf_inst__DOT__wd_rf),32);
    ...
    bufp->fullBit(oldp+96,((vlSelfRef.tb_insertion_sort__DOT__dut__DOT__forwarded_rs1_2 
                            < vlSelfRef.tb_insertion_sort__DOT__dut__DOT__forwarded_rs2_2)));
    bufp->fullCData(oldp+97,((0x0000007fU & (vlSelfRef.tb_insertion_sort__DOT__dut__DOT__alu_inst__DOT__result 
                                             >> 2U))),7);
