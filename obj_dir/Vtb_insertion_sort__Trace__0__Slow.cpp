...
VL_ATTR_COLD void Vtb_insertion_sort___024root__trace_init_sub__TOP__0(Vtb_insertion_sort___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    VL_TRACE_DECL_BUS(tracep,c+2,0,"val2",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+3,0,"val3",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+97,0,"word_addr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 10,0);
...
VL_ATTR_COLD void Vtb_insertion_sort___024root__trace_full_0_sub_0(Vtb_insertion_sort___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    bufp->fullIData(oldp+0,(vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory[0U]),32);
    bufp->fullIData(oldp+1,(vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory[1U]),32);
    bufp->fullIData(oldp+2,(vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory[2U]),32);
    bufp->fullIData(oldp+3,(vlSelfRef.tb_insertion_sort__DOT__dut__DOT__dmem_inst__DOT__memory[3U]),32);
    ...
    bufp->fullBit(oldp+96,((vlSelfRef.tb_insertion_sort__DOT__dut__DOT__forwarded_rs1_2 
                            < vlSelfRef.tb_insertion_sort__DOT__dut__DOT__forwarded_rs2_2)));
    bufp->fullSData(oldp+97,((0x000007ffU & (vlSelfRef.tb_insertion_sort__DOT__dut__DOT__alu_inst__DOT__result 
                                             >> 2U))),11);
