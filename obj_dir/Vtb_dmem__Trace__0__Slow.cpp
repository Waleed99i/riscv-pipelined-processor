...
VL_ATTR_COLD void Vtb_dmem___024root__trace_init_sub__TOP__0(Vtb_dmem___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    VL_TRACE_DECL_BIT(tracep,c+6,0,"clk",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BUS(tracep,c+7,0,"mem_rdata",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+7,0,"mem_rdata",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_PUSH_PREFIX(tracep, "unnamedblk1", VerilatedTracePrefixType::SCOPE_MODULE, 0, 0);
    VL_TRACE_DECL_BUS(tracep,c+8,0,"current_word",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+9,0,"half_word",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 15,0);
    VL_TRACE_DECL_BUS(tracep,c+10,0,"byte_val",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 7,0);
...
VL_ATTR_COLD void Vtb_dmem___024root__trace_full_0_sub_0(Vtb_dmem___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+6,(vlSelfRef.tb_dmem__DOT__clk));
    bufp->fullIData(oldp+7,(vlSelfRef.tb_dmem__DOT__mem_rdata),32);
    bufp->fullIData(oldp+8,(vlSelfRef.tb_dmem__DOT__dut__DOT__unnamedblk1__DOT__current_word),32);
    bufp->fullSData(oldp+9,(vlSelfRef.tb_dmem__DOT__dut__DOT__unnamedblk1__DOT__half_word),16);
    bufp->fullCData(oldp+10,(vlSelfRef.tb_dmem__DOT__dut__DOT__unnamedblk1__DOT__byte_val),8);
}
